...
plot1 <- ggplot(AnnAvgLagData, aes(x = LagAnnAvg))
  plot2 <- plot1 + geom_point(aes(y = Midpoint),size=3) + labs (y="Midpoint \n (day of year)", x="Annual Average SST - One Year Lag (°C)", tag="B")+ theme_bw(base_size=15)
  
  # adding the relative humidity data, transformed to match roughly the range of the temperature
  plot3 <- plot1 + geom_point(aes(y = CohortWidth),size=3) + labs (y="Cohort Width \n (days)", x="Annual Average SST - One Year Lag (°C)", tag="A")+ theme_bw(base_size=15)
